...
# HTTP layer
HTTP_REQUESTS = Counter("app_http_requests_total", "HTTP requests", ["path", "method", "status"])
...
RETRIEVAL_LATENCY = Histogram(
    "app_retrieval_stage_seconds",
    "Retrieval stage duration (s)",
    ["stage"],  # stage: search|rerank
)
GENERATION_LATENCY = Histogram("app_generation_seconds", "LLM generation duration (s)")
